...
export class Salesforcecc implements INodeType {
	description: INodeTypeDescription = {
		...
		description: 'Consume Salesforcecc API',
		defaults: {
			name: 'Salesforcecc',
		},
		usableAsTool: true,
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		this.logger.debug(
			`Running "Salesforcecc" node named "${this.getNode.name}" resource "${resource}" operation "${operation}"`,
		);

		for (let i = 0; i < items.length; i++) {
			try {
				if (resource === 'lead') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Lead/post-lead
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Lead/patch-lead-id
					if (operation === 'update') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Lead/get-lead-id
					if (operation === 'get') {
						const leadId = this.getNodeParameter('leadId', i) as string;
						responseData = await salesforceApiRequest.call(this, 'GET', `/sobjects/lead/${leadId}`);
					}
					//https://developer.salesforcecc.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
					if (operation === 'getAll') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Lead/delete-lead-id
					if (operation === 'delete') {
						const leadId = this.getNodeParameter('leadId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Lead/get-lead
					if (operation === 'getSummary') {
						responseData = await salesforceApiRequest.call(this, 'GET', '/sobjects/lead');
					}
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/CampaignMember
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Note/post-note
				...
				if (resource === 'contact') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Contact/post-contact
					if (operation === 'create' || operation === 'upsert') {
						const additionalFields = this.getNodeParameter('additionalFields', i);
						const lastname = this.getNodeParameter('lastname', i) as string;
						const body: IContact = {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Contact/patch-contact-id
					if (operation === 'update') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Contact/get-contact-id
					if (operation === 'get') {
						const contactId = this.getNodeParameter('contactId', i) as string;
						responseData = await salesforceApiRequest.call(
							this,
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Contact/delete-contact-id
					if (operation === 'delete') {
						const contactId = this.getNodeParameter('contactId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Contact/get-contact
					if (operation === 'getSummary') {
				...
				if (resource === 'document') {
					//https://developer.salesforcecc.com/docs/atlas.en-us.206.0.api_rest.meta/api_rest/dome_sobject_insert_update_blob.htm
					if (operation === 'upload') {
						const title = this.getNodeParameter('title', i) as string;
						const additionalFields = this.getNodeParameter('additionalFields', i);
				...
				if (resource === 'opportunity') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Opportunity/post-opportunity
					if (operation === 'create' || operation === 'upsert') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Opportunity/get-opportunity-id
					if (operation === 'get') {
						const opportunityId = this.getNodeParameter('opportunityId', i) as string;
						responseData = await salesforceApiRequest.call(
							this,
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Opportunity/delete-opportunity-id
					if (operation === 'delete') {
						const opportunityId = this.getNodeParameter('opportunityId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Opportunity/get-opportunity
					if (operation === 'getSummary') {
				...
				if (resource === 'account') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Account/post-account
					if (operation === 'create' || operation === 'upsert') {
						const additionalFields = this.getNodeParameter('additionalFields', i);
						const name = this.getNodeParameter('name', i) as string;
						const body: IAccount = {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Account/patch-account-id
					if (operation === 'update') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Account/get-account-id
					if (operation === 'get') {
						const accountId = this.getNodeParameter('accountId', i) as string;
						responseData = await salesforceApiRequest.call(
							this,
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Account/delete-account-id
					if (operation === 'delete') {
						const accountId = this.getNodeParameter('accountId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Account/get-account
					if (operation === 'getSummary') {
				...
				if (resource === 'case') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Case/post-case
					if (operation === 'create') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Case/patch-case-id
					if (operation === 'update') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Case/get-case-id
					if (operation === 'get') {
						const caseId = this.getNodeParameter('caseId', i) as string;
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Case/delete-case-id
					if (operation === 'delete') {
						const caseId = this.getNodeParameter('caseId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Case/get-case
					if (operation === 'getSummary') {
						responseData = await salesforceApiRequest.call(this, 'GET', '/sobjects/case');
					}
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/CaseComment/post-casecomment
				...
				if (resource === 'task') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Task/post-task
					if (operation === 'create') {
						const additionalFields = this.getNodeParameter('additionalFields', i);
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Task/patch-task-id
					if (operation === 'update') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Task/get-task-id
					if (operation === 'get') {
						const taskId = this.getNodeParameter('taskId', i) as string;
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Task/delete-task-id
					if (operation === 'delete') {
						const taskId = this.getNodeParameter('taskId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Task/get-task
					if (operation === 'getSummary') {
						responseData = await salesforceApiRequest.call(this, 'GET', '/sobjects/task');
					}
				}
				if (resource === 'attachment') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Attachment/post-attachment
					if (operation === 'create') {
						const name = this.getNodeParameter('name', i) as string;
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Attachment/patch-attachment-id
					if (operation === 'update') {
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Attachment/get-attachment-id
					if (operation === 'get') {
						const attachmentId = this.getNodeParameter('attachmentId', i) as string;
						responseData = await salesforceApiRequest.call(
							this,
					...
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/Attachment/delete-attachment-id
					if (operation === 'delete') {
						const attachmentId = this.getNodeParameter('attachmentId', i) as string;
						try {
							responseData = await salesforceApiRequest.call(
				...
				if (resource === 'user') {
					//https://developer.salesforcecc.com/docs/api-explorer/sobject/User/get-user-id
					if (operation === 'get') {
				...
				if (resource === 'flow') {
					//https://developer.salesforcecc.com/docs/atlas.en-us.api_action.meta/api_action/actions_obj_flow.htm
					if (operation === 'invoke') {
